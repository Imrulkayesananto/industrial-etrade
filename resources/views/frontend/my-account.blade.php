    ...
    <div class="container">
        <div class="axil-dashboard-warp">
            <div class="axil-dashboard-author">
                <div class="media">
                    <div class="thumbnail">
                        <img src="https://api.dicebear.com/9.x/initials/svg?seed={{ auth('customer')->user()->name }}"
                            alt="Hello {{ auth('customer')->user()->name }}" width="100px">
                    </div>
                    <div class="media-body">
                        <h5 class="title mb-0">Hello {{ auth('customer')->user()->name }}</h5>
                        <span class="joining-date">eTrade Member Since Sep {{
                            auth('customer')->user()->created_at->format('Y, d M') }}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <nav class="axil-dashboard-nav">
                            <div class="nav nav-tabs" role="tablist">
                                ...
                                <a class="nav-item nav-link" data-bs-toggle="tab" href="my-account.html#nav-orders"
                                    role="tab" aria-selected="false"><i class="fas fa-shopping-basket"></i>Orders</a>
                                <a class="nav-item nav-link" data-bs-toggle="tab" href="my-account.html#nav-downloads"
                                    role="tab" aria-selected="false"><i class="fas fa-file-download"></i>Downloads</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb--40">
                                                    ...
                                                    <p class="b3 mt--10">This will be how your name will be displayed in
                                                        the account section and in reviews</p>
                                                </div>
                                            </div>
                                            <div class="col-12">
