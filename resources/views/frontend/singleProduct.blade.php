                    ...
                    <div class="row">
                        <div class="col-lg-10 order-lg-2">
                            <div class="single-product-thumbnail-wrap zoom-gallery">
                                <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                    ...
                                    <div class="thumbnail">
                                        <a href="{{ asset('storage/'. $gallImg) }}" class="popup-zoom">
                                            <img src="{{ asset('storage/'. $gallImg) }}" alt="Product Images">
                                        </a>
                                    </div>
                                    @endforeach
                                    @endif
                        ...
                        <div class="col-lg-2 order-lg-1">
                            <div class="product-small-thumb-3 small-thumb-wrapper">
                                ...
                                @foreach (json_decode($product->gall_img) as $gallImg)
                                <div class="small-thumb-img">
                                    <img src="{{ asset('storage/'. $gallImg) }}" alt="thumb image">
                                </div>
                                @endforeach
                                @endif
                ...
                <div class="col-lg-5 mb--40">
                    <div class="single-product-content">
                        <div class="inner">
                            ...
                            <span class="price-amount">BDT {{ number_format(($product->selling_price &&
                                $product->selling_price > 0) ? $product->selling_price : $product->price, 2) }}</span>
                            ...
                            <form action="{{ route('frontend.addToCart') }}" method="POST">
                                ...
                                <div class="product-action-wrapper d-flex-center">
                                    ...
                                    <ul class="product-action d-flex-center mb--0">
                                        <li class="add-to-cart"><button type="submit" class="axil-btn btn-bg-primary">Add to
                                                Cart</button></li>
        ...
        <div class="container">
            <ul class="nav tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="active" id="description-tab" data-bs-toggle="tab" href="single-product-3.html#description"
